  ...
  public class AccountController : Controller
  {
    ...
    public async Task<IActionResult> Register(RegisterViewModel registerViewModel)
    {
      ...
      if (res.Succeeded)
      {
        ...
        await _emailSender.SendEmailAsync(user.Email, "ConfirmationLink", $"Thanks for registering on BidMe. Click on this link to confirm registration-> <a href={confirmationLink}>Confirmation Link</a>");
